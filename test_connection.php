...
if ($result->num_rows > 0) {
    ...
    if ($admin_check->num_rows > 0) {
        ...
        if (password_verify($test_password, $admin['password'])) {
            ...
            echo "<p style='color:orange;'>⚠️ If you still can't login, check your admin_login.php file</p>";
        } else {
            echo "<p style='color:red;'>❌ Password 'admin123' VERIFICATION FAILED!</p>";
            echo "<p style='color:orange;'>⚠️ Need to reset password. See solution below.</p>";
