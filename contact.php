...
$conn = mysqli_connect("localhost", "root", "", "group 6 unisan website");

if (!$conn) {
    die("Connection failed: " . mysqli_connect_error());
}

$user_sname = $_POST['user_name'];
$email = $_POST['email'];
$phone_number = $_POST['phone_number'];
$mess = $_POST['mess'];

$sql = "INSERT INTO lgu_tb (user_name, email, phone_number, mess)
        VALUES ('$user_name', '$email', '$phone_number', '$mess')";
...
<body>
        ...
        <article class="card" aria-labelledby="contactTitle">
            ...
            <form id="contactForm" novalidate aria-describedby="formInstructions" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <input type="email" id="emailInput" name="email" required aria-required="true"
                        aria-describedby="emailError" />
                    <div id="emailError" class="error-message">Please enter a valid email address.</div>
                    <label for="phoneInput">Phone Number</label>
                    <input type="tel" id="phoneInput" name="phone" pattern="^\+?[0-9\s\-]{7,15}$"
                        aria-describedby="phoneError" placeholder="+63 912 345 6789" />
                    <div id="phoneError" class="error-message">Please enter a valid phone number.</div>
                    <label for="messageInput">Message</label>
                    <textarea id="messageInput" name="message" rows="5" required aria-required="true"
                        aria-describedby="messageError"></textarea>
                    <div id="messageError" class="error-message">Please enter your message.</div><br>
                    <input
                        style="padding-top: 15px; color: #fff; background-color: #0b3d91; border: none; border-radius: 5px; padding: 10px 20px; cursor: pointer;"
    ...
    <footer class="footer">
        <div class="footer-container">
            ...
            <div class="footer-section">
                <h3>About GovPH</h3>
                <p>Learn more about the Philippine government, its structure, how government works and the people behind
                    it.</p>
                <ul>
